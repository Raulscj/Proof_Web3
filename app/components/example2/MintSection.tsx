...
const MintSection = () => {
  ...
  useWaitForTransaction({
    ...
    /**
    *  Uno puede utilizar el onError() devolución de llamada  para actuar ante el fracaso 
    * de la transacción. 
    *  También existe el onSettled() se utiliza cuando la transacción ha fallado o ha 
    * tenido éxito (pero en toda forma, se ha resuelto).
    */
  });
